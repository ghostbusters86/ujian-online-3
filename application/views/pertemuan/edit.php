        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <textarea name="materi" class="form-control" rows="4" cols="50" placeholder="Materi"><?=$pertemuan->materi?></textarea>
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    var tgl_mulai = '<?=$pertemuan->tanggal_mulai?>';
    var terlambat = '<?=$pertemuan->tanggal_selesai?>';
</script>

<script src="<?=base_url()?>assets/dist/js/app/pertemuan/edit.js"></script>