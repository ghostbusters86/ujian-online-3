...
';
foreach ($hasil_ujian as $datahasil) {
    # code...
    $oo .= '

        <tr>
            <td>'.$datahasil->soal_essay.'</td>
            <td>'.$datahasil->bobot.'</td>
            <td>'.$datahasil->nilai.'</td>
        </tr>
...
$pdf->writeHTML($oo, true, 0, true, 0);
// reset pointer to the last page
$pdf->lastPage();
// ---------------------------------------------------------

//Close and output PDF document
$pdf->Output($ujian->nama_ujian_essay.'_'.$mhs->nim.'.pdf', 'I');
// }