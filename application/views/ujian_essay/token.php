            ...
            <div class="col-sm-6">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Terlambat</th>
                        <td>
                            <?=strftime('%d %B %Y', strtotime($ujian->tanggal_selesai))?> 
                            <?=date('H:i:s', strtotime($ujian->tanggal_selesai))?>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="col-sm-6">
                <div class="box box-solid">
                    <div class="box-body pb-0">
                        ...
                        <?php
                        $mulai = strtotime($ujian->tanggal_mulai);
                        $terlambat = strtotime($ujian->tanggal_selesai);
                        $now = time();
                        if($mulai > $now) : 
                        ?>
                        <div class="callout callout-success">
                            ...
                            <br>
                            <span class="countdown" data-time="<?=date('Y-m-d H:i:s', strtotime($ujian->tanggal_mulai))?>">00 Hari, 00 Jam, 00 Menit, 00 Detik</strong><br/>
                        </div>
                        <?php elseif( $terlambat > $now ) : ?>
                        <button id="btncek" data-id="<?=$ujian->id_ujian_essay?>" class="btn btn-success btn-lg mb-4">
                            <i class="fa fa-pencil"></i> Mulai
                        </button>
                        <div class="callout callout-danger">
                            <i class="fa fa-clock-o"></i> <strong class="countdown" data-time="<?=date('Y-m-d H:i:s', strtotime($ujian->tanggal_selesai))?>">00 Hari, 00 Jam, 00 Menit, 00 Detik</strong><br/>
