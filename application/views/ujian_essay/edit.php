<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                <?=form_open('ujian_essay/save', array('id'=>'formujian'), array('method'=>'edit','id_dosen'=>$dosen->id_dosen, 'id_matkul'=>$matkul->matkul_id, 'id_ujian_essay'=>$ujian->id_ujian_essay))?>
                <div class="form-group">
                    <label for="nama_ujian">Nama Ujian Essay</label>
                    <input value="<?=$ujian->nama_ujian_essay?>" autofocus="autofocus" onfocus="this.select()" placeholder="Nama Ujian Essay" type="text" class="form-control" name="nama_ujian">
...
<script type="text/javascript">
    var tgl_mulai = '<?=$ujian->tanggal_mulai?>';
    var terlambat = '<?=$ujian->tanggal_selesai?>';
</script>
