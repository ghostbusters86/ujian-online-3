<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-sm-4">
                <?=form_open('ujian_essay/save', array('id'=>'formujian'), array('method'=>'add','dosen_id'=>$dosen->id_dosen, 'matkul_id'=>$matkul->matkul_id))?>
                <div class="form-group">
                    <label for="nama_ujian">Nama Ujian Essay</label>
                    <input autofocus="autofocus" onfocus="this.select()" placeholder="Nama Ujian Essay" type="text" class="form-control" name="nama_ujian">
