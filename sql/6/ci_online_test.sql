...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Jul 2020 pada 00.43
...
(86, '5efc302f87126', 1, 'satu', '0', ''),
(87, '5efc302f87126', 2, 'dua', '0', '');
...
CREATE TABLE `h_absensi` (
  ...
  `ttd_digital` varchar(200) NOT NULL,
...
INSERT INTO `h_absensi` (`id_absensi`, `id_pertemuan`, `id_mahasiswa`, `ttd_digital`, `waktu`, `keterangan`, `created_at`) VALUES
(4, 2, 1, '5eff436490dfa.png', '2020-07-03 21:40:36', 'H', '2020-07-03 21:40:36'),
(9, 2, 3, '', '2020-07-04 14:56:51', 'S', '2020-07-04 14:56:51');
...
INSERT INTO `h_tugas` (`id`, `id_tugas`, `id_mahasiswa`, `tugas_mahasiswa`, `nilai`, `ext`, `deskripsi`, `waktu`, `telat`, `created_at`, `updated_at`) VALUES
(13, 14, 1, 'b91619783abddaa4eda42a14cf621336.pdf', 0, '.pdf', 'wkwkwkw', '2020-07-02 19:37:35', 'Y', '2020-06-21 15:49:46', '2020-07-02 12:37:35'),
(15, 1, 2, '41155ef1bdd971530a5da0914bbd8266.docx', 75, '', '', '2020-06-22 19:58:51', 'Y', '2020-06-22 12:58:51', '2020-06-22 12:58:51'),
(16, 1, 3, '99e511e510be7f6ad43c305b9292e89f.docx', 60, '', '', '2020-06-22 20:07:26', 'Y', '2020-06-22 13:07:26', '2020-06-22 13:07:26'),
(17, 1, 1, '1fdf138c8390e0fe1b93b31d11e47c02.xlsx', 75, '.xlsx', 'hahahaha', '2020-06-23 09:42:42', 'N', '2020-06-23 02:40:57', '2020-06-23 02:42:42'),
(18, 16, 1, '1eac87723feb0174699259299c180819.pdf', 100, '.pdf', '', '2020-06-25 13:45:35', 'Y', '2020-06-25 06:07:56', '2020-06-25 06:45:35'),
(19, 17, 1, '24d4ef12d077955ee43af027b63520ed.pdf', 0, '.pdf', 'tidakbisa', '2020-07-02 19:28:10', 'Y', '2020-07-02 12:27:20', '2020-07-02 12:28:10'),
(20, 18, 1, '973036fc9d22745785ac43b6fd8ce8bf.pdf', 0, '.pdf', 'datakuu', '2020-07-02 19:39:18', 'N', '2020-07-02 12:39:18', '2020-07-02 12:39:18'),
(21, 11, 1, '6ca23d8e13e42c6ab7cad21c5f45607c.pdf', 0, '.pdf', 'ini engumpulkan', '2020-07-02 19:50:01', 'Y', '2020-07-02 12:50:01', '2020-07-02 12:50:01');
...
('5efc302f87126', 4, 1, '1|2', '1:satu:N|2:dua:N', '0', '0', '2020-07-01 13:41:51', '2020-07-01 14:11:51', 'N', 'Y');
...
(3, '::1', 'bakaran@gmail.com', 1593847676),
(4, '::1', 'mahasiswa@gail.com', 1593922023);
...
(2, 'Telo Goreng', '20000000', 'telo@gmail.com', 'L', 2),
(3, 'Ayam goreng', '300000', 'bakaran@gmail.com', 'L', 1),
(4, 'Ayam ', '30000000', 'bakar@gmail.com', 'L', 3);
...
--
-- Struktur dari tabel `m_pertemuan`
--

CREATE TABLE `m_pertemuan` (
  `id_pertemuan` int(11) NOT NULL,
  `id_matkul` int(11) NOT NULL,
  `id_dosen` int(11) NOT NULL,
  `id_kelas` int(11) NOT NULL,
  `nama_pertemuan` longtext NOT NULL,
...
--
-- Dumping data untuk tabel `m_pertemuan`
--

INSERT INTO `m_pertemuan` (`id_pertemuan`, `id_matkul`, `id_dosen`, `id_kelas`, `nama_pertemuan`, `materi`, `file_materi`, `tanggal_mulai`, `tanggal_selesai`, `token`, `created_at`, `updated_at`) VALUES
(2, 1, 1, 1, 'www', 'www', '', '2020-07-03 15:23:31', '2020-07-04 19:23:32', '5efeb2c938', '2020-07-03 11:23:37', '2020-07-03 11:23:37'),
(3, 1, 1, 1, 'oooo', 'ooooo', '', '2020-07-04 11:36:25', '2020-07-05 11:36:28', '5f00075050', '2020-07-04 11:36:32', '2020-07-04 11:36:32'),
(4, 1, 1, 3, 'tttt', 'tttt', '', '2020-07-04 11:37:02', '2020-07-05 11:37:03', '5f000c01cc', '2020-07-04 11:37:05', '2020-07-04 11:37:05');
...
INSERT INTO `reset_password` (`id`, `email`, `kode_unik`, `kadaluarsa`, `created_at`) VALUES
(5, 'andifraternal@gmail.com', '15f01603cbbaf4', '2020-07-05 12:13:16', '2020-07-05 12:08:16');
...
(3, '::1', '12183018', '$2y$10$1Lz5qkf9GEHz1ncvrUL.LOfOrRRcpPy0BzgX5a/XbDXpHjdw5oik2', 'mahasiswa@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1550225511, 1593923713, 1, 'Muhammad', 'Arfananda', NULL, NULL),
(4, '::1', '12345678', '$2y$10$yVOPJCnjxn326AJfcBduku6R2U2hnz9g2xfZkEVaTVRq69BGcX0bi', 'andifraternal@gmail.com', NULL, NULL, 'e74555b5955c0c794751', '$2y$10$6MgiBfyQAbvOyVc8/Q8Nq.gpN4lWFiVjEf/cGBZ7QkFRVzY8tM/Lm', 1593925692, NULL, NULL, 1550226286, 1593847967, 1, 'Koro', 'Sensei', NULL, NULL),
...
(9, '::1', '20000000', '$2y$10$yVOPJCnjxn326AJfcBduku6R2U2hnz9g2xfZkEVaTVRq69BGcX0bi', 'telo@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1550289356, 1593835830, 1, 'Telo', 'Goreng', NULL, NULL),
...
--
-- Indeks untuk tabel `m_pertemuan`
--
ALTER TABLE `m_pertemuan`
...
--
-- AUTO_INCREMENT untuk tabel `m_pertemuan`
--
ALTER TABLE `m_pertemuan`
